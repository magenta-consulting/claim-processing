...
//		$query->setSortBy([ [ 'fieldName' => '' ] ], [ 'fieldName' => 'receiptDate' ]);
//		$query->setSortOrder('ASC');
	...
	protected function configureFormFields(FormMapper $formMapper) {
		...
		$formMapper
			...
			->add('employeeNo', 'text')
			->add('contactNumber', PhoneNumberType::class, array(
				'required'                  => false,
				'widget'                    => PhoneNumberType::WIDGET_COUNTRY_CHOICE,
				'country_choices'           => array( 'SG' ),
				'preferred_country_choices' => array( 'SG' )
			))
		...
		if($this->isCLient() || $this->isHr()) {
			...
			$formMapper->tab('Appointed Proxy Submitter')
			           ...
			           ->add('submissionBy', 'sonata_type_collection', array(
				           'required' => false,
			           ), array(
					           'edit'            => 'inline',
					           'inline'          => 'table',
		...
		switch($type) {
			...
			case 'approving':
				$listMapper->add('employeeNo', null, [ 'label' => 'Employee No', 'sortable' => false ])
				           ...
				           ->add('employeeGroup.costCentre.code', null, [
					           'label'    => 'Cost Centre',
					           'sortable' => false
				           ])
